...
namespace WebApplication3.Controllers
{
    public class CoachesController : Controller
    {
        ...
        public CoachesController(WebApplication3Context context)
        {
            _context = context;
        }
        ...
        {
            var webApplication3Context = _context.Coach.Include(c => c.Team);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,NumberOfTitles,Country,BirthDate,TeamId")] Coach coach)
        {
            if (id != coach.Id)
            {
                return NotFound();
